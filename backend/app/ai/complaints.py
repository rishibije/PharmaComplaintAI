...
async def analyze_complaint(
    ...
    try:
        complaint_record = Complaint(
            ...
            product_strength=complaint_data.get("product_strength"),
            ...
            complaint_date=complaint_data.get("complaint_date"),
            description=complaint_data.get("description"),
            severity=complaint_data.get("severity"),
            priority=complaint_data.get("priority"),
            risk_level=risk_data.get("risk_level"),
            risk_reason=risk_data.get("reason"),
            completeness_score=completeness_data.get("score"),
            is_sufficient=str(
                completeness_data.get("is_sufficient", False)
            ),
            summary=summary_data,
            capa_recommendation=json.dumps(capa_data),
        )
